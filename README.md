...
> [`docs/multi-agent-setup.md`](docs/multi-agent-setup.md).

## Development

```bash
npm install
npm run dev        # Vite dev server (proxies /api → localhost:8642)
...
Vue 3 · Vite · Pinia · Dexie (IndexedDB) · Tailwind CSS v4 · vite-plugin-pwa

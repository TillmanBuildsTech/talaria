    ...
    <div className="relative shrink-0 flex items-center gap-1.5">
      ...
      {open && (
        <>
          ...
          <div className="absolute left-0 top-full mt-2 w-72 max-w-[80vw] max-h-[70dvh] overflow-y-auto z-40 bg-slate-800 rounded-xl border border-slate-700 shadow-xl">
